package edu.ucsb.cs56.w15.drawings.jattsharpunjabda.simple;
...
/**
   ...
   @author Simranjit Singh Sekhon (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      g2.draw(snowManTopCircle);
       ...
       g2.drawString("Top of snowman added by Simranjit Singh Sekhon", 20,40);
    }
